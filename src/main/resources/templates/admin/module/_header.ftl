<header class="main-header">
    <a href="/admin" class="logo">
        <span class="logo-mini"><b>Ju</b>mp</span>
        <span class="logo-lg"><b>Ju</b>mp</span>
    </a>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<#if user.userAvatar?if_exists!="">${user.userAvatar}<#else >/static/jump-backend/images/default.png</#if>" class="user-image" alt="User Image">
                        <span class="hidden-xs">${user.userDisplayName!}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="user-header">
                            <img src="<#if user.userAvatar?if_exists!="">${user.userAvatar}<#else >/static/jump-backend/images/default.png</#if>" class="img-circle" alt="User Image">
