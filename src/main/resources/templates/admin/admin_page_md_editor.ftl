...
<#compress >
            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div>
                            <img src="<#if post??>${post.postThumbnail!'/static/jump-frontend/images/thumbnail/thumbnail.png'}<#else>/static/jump-frontend/images/thumbnail/thumbnail.png</#if>" class="img-responsive img-thumbnail" id="selectImg" onclick="jump.layerModal('/admin/attachments/select?id=selectImg','<@spring.message code="common.js.all-attachment" />')" style="cursor: pointer;">
                        </div>
                    </div>
                    <div class="box-footer">
    ...
    function push(status) {
        ...
        $.post('/admin/page/new/push',{
            ...
            if(data.code===1){
                ...
                easyMDE.toTextArea();
                easyMDE = null;
                jump.showMsgAndRedirect(data.msg,'success',1000,'/admin/page',"${options.admin_pjax!'true'}");
            }else{
                jump.showMsg(data.msg,'error',2000);
            }
        },'JSON');
