...
<script src="/static/jump-backend/plugins/clipboard/clipboard.min.js"></script>
...
<script>
    ...
    $('.thumbnail').click(function () {
        jump.showMsg("<@spring.message code='admin.attachments.modal.js.copy-success' />",'success',1000);
    })
</script>
</html>
