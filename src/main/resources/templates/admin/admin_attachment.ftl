    ...
    <section class="content container-fluid" id="animated-content">
        ...
        <div class="row">
            <#list attachments.content as attachment>
                <div class="col-lg-2 col-md-3 col-sm-6 col-xs-6 div-thumbnail" onclick="jump.layerModal('/admin/attachments/attachment?attachId=${attachment.attachId?c}','<@spring.message code="admin.attachments.modal.detail-title" />')">
...
<script type="application/javascript" id="footer_script">
    $('#uploadImg').fileinput({
        ...
        $("#uploadForm").hide(400);
        jump.showMsgAndRedirect('上传成功！','success',1000,'/admin/attachments',"${options.admin_pjax!'true'}");
    });
