...
<link type="text/css" rel="stylesheet" href="/static/jump-common/OwO/OwO.min.css">
<link type="text/css" rel="stylesheet" href="/static/jump-frontend/css/comment.min.css">
<style>
${options.native_css!}
</style>
...
<script src="/static/jump-frontend/plugins/md5/md5.min.js"></script>
<script src="/static/jump-frontend/plugins/ua-parser/ua-parser.min.js"></script>
<script src="/static/jump-common/OwO/OwO.min.js"></script>
<#if (options.comment_activate_power_mode!'false') == "true">
<script src="/static/jump-frontend/plugins/activate-power-mode/activate-power-mode.js"></script>
<script>
...
<script src="/static/jump-frontend/js/comment.min.js"></script>
</@compress>
