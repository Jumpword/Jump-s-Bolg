...
import cn.jump.blog.model.domain.Attachment;
import cn.jump.blog.model.dto.QiNiuPutSet;
import cn.jump.blog.model.enums.AttachLocationEnum;
import cn.jump.blog.model.enums.BlogPropertiesEnum;
import cn.jump.blog.repository.AttachmentRepository;
import cn.jump.blog.service.AttachmentService;
import cn.jump.blog.service.base.AbstractCrudService;
import cn.jump.blog.utils.BlogUtils;
import cn.jump.blog.utils.Md5Util;
...
public class AttachmentServiceImpl extends AbstractCrudService<Attachment, Long> implements AttachmentService {
    ...
    public Map<String, String> attachUpload(MultipartFile file, HttpServletRequest request) {
        ...
        try {
            ...
            final String size = BlogUtils.parseSize(new File(fullPath.toString()).length());
            final String wh = BlogUtils.getImageWh(new File(fullPath.toString()));
    ...
    public Map<String, String> attachQiNiuUpload(MultipartFile file, HttpServletRequest request) {
        ...
        try {
            ...
            resultMap.put("size", BlogUtils.parseSize(file.getSize()));
