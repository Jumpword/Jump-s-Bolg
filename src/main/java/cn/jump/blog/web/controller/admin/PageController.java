...
public class PageController {
    ...
    public String newPage(Model model) {
        final List<String> customTpls = BlogUtils.getCustomTpl(OPTIONS.get(BlogPropertiesEnum.THEME.getProp()));
    ...
    public JsonResult pushPage(@ModelAttribute Post post, HttpSession session) {
        ...
        try {
            ...
            if (StrUtil.equals(post.getPostThumbnail(), BlogPropertiesEnum.DEFAULT_THUMBNAIL.getProp())) {
                post.setPostThumbnail(OPTIONS.get(BlogPropertiesEnum.BLOG_URL.getProp()) + "/static/jump-frontend/images/thumbnail/thumbnail-" + RandomUtil.randomInt(1, 11) + ".jpg");
            }
