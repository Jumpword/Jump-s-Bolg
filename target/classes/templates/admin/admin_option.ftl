                                        ...
                                        <div class="col-lg-4 col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn">
                                                    <button class="btn btn-default btn-flat" type="button" onclick="jump.layerModal('/admin/attachments/select?id=blogLogo','<@spring.message code="common.js.all-attachment" />')"><@spring.message code='common.btn.choose' /></button>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4 col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn">
                                                    <button class="btn btn-default btn-flat" type="button" onclick="jump.layerModal('/admin/attachments/select?id=blogFavicon','<@spring.message code="common.js.all-attachment" />')"><@spring.message code='common.btn.choose' /></button>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4 col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn">
                                                    <button class="btn btn-default btn-flat" type="button" onclick="jump.layerModal('/admin/attachments/select?id=adminLayoutBoxedBackground','<@spring.message code="common.js.all-attachment" />')"><@spring.message code='common.btn.choose' /></button>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
...
<script type="application/javascript" id="footer_script">
    ...
    function updateAllSummary() {
        $.get('/admin/posts/updateSummary',{'postSummary' : $('#postSummary').val()},function (data) {
            if(data.code === 1){
                jump.showMsg(data.msg,'success',1000);
            }else{
