<#compress >
            ...
            <form>
                <div class="form-group animated fadeInUp" style="animation-delay: 0.1s">
                    <input type="text" class="form-control" name="loginName" id="loginName"
                           placeholder="<@spring.message code='login.form.loginName' />" autocomplete="username">
                </div>
                <div class="form-group animated fadeInUp" style="animation-delay: 0.2s">
                    <input type="password" class="form-control" name="loginPwd" id="loginPwd"
                           placeholder="<@spring.message code='login.form.loginPwd' />" autocomplete="current-password">
                </div>
                <button type="button" id="btnLogin" data-loading-text="<@spring.message code='login.btn.logining' />"
                        class="btn btn-block login-button animated fadeInUp" onclick="doLogin()"
                        style="animation-delay: 0.4s;outline: none;"><@spring.message code='login.btn.login' /></button>
            </form>
        </div>
    </div>
    </body>
    ...
    <script src="/static/jump-backend/js/login.min.js"></script>
    </html>
</#compress>
