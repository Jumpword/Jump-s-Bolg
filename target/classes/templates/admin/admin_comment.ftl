...
<div class="content-wrapper">
    <link rel="stylesheet" href="/static/jump-common/OwO/OwO.min.css">
...
<script type="application/javascript" id="footer_script">
    var s = new OwO({
        ...
        width: '100%',
        maxHeight: '210px',
        api:"/static/jump-common/OwO/OwO.min.json"
    });
    ...
    function reply() {
        $.post('/admin/comments/reply',{
            ...
            'postId': $("#postId").val(),
            'commentContent': jump.formatContent($("#commentContent").val())
        },function(data) {
            if(data.code === 1){
