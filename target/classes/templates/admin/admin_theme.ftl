...
<div class="content-wrapper">
    ...
    <section class="content-header" id="animated-header">
        ...
        <a class="btn-header" id="showForm" href="javascript:void(0)" onclick="jump.layerModal('/admin/themes/install','<@spring.message code="admin.themes.js.install-theme" />')">
...
<script type="application/javascript" id="footer_script">
    ...
    function setTheme(site_theme) {
        $.get('/admin/themes/set',{'siteTheme': site_theme},function(data) {
            if(data.code === 1){
                jump.showMsgAndRedirect(data.msg,'success',1000,'/admin/themes',"${options.admin_pjax!'true'}");
            }else{
