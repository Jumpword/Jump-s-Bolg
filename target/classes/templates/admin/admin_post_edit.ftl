...
<div class="content-wrapper">
    <link rel="stylesheet" href="/static/jump-backend/plugins/easymde/easymde.min.css">
    <link rel="stylesheet" href="/static/jump-backend/plugins/jquery-tageditor/jquery.tag-editor.css">
    <link rel="stylesheet" href="/static/jump-backend/plugins/datetimepicker/css/bootstrap-datetimepicker.min.css">
    <style type="text/css">
        #postTitle{font-weight: 400;}
    </style>
    <section class="content-header" id="animated-header">
        <h1 style="display: inline-block;"><@spring.message code='admin.posts.edit.title' /></h1>
        <a class="btn-header" id="btnOpenAttach" href="javascript:void(0)" onclick="jump.layerModal('/admin/attachments/select?type=post','<@spring.message code="common.js.all-attachment" />')">
...
<#compress >
            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div>
                            <img src="${post.postThumbnail!'/static/jump-frontend/images/thumbnail/thumbnail.png'}" class="img-responsive img-thumbnail" id="selectImg" onclick="jump.layerModal('/admin/attachments/select?id=selectImg','<@spring.message code="common.js.all-attachment" />')" style="cursor: pointer;">
                        </div>
                    </div>
                    <div class="box-footer">
...
<script type="application/javascript" id="footer_script">
    ...
    function urlOnBlurAuto() {
        ...
        if(newPostUrl.val()===""){
            jump.showMsg("<@spring.message code='admin.editor.js.no-url' />",'info',2000);
            return;
        }
        $.get('/admin/posts/checkUrl',{'postUrl': newPostUrl.val()},function (data) {
            if(data.code===0){
                jump.showMsg(data.msg,'error',2000);
                return;
            }else{
    ...
    function push(status) {
        ...
        if(!postTitle.val()){
            jump.showMsg("<@spring.message code='admin.editor.js.no-title' />",'info',2000);
            return;
        }
        if(!postUrl.html()){
            jump.showMsg("<@spring.message code='admin.editor.js.no-url' />",'info',2000);
        ...
        $.post('/admin/posts/update',{
            ...
            if(data.code === 1){
                ...
                easyMDE.toTextArea();
                easyMDE = null;
                jump.showMsgAndRedirect(data.msg,'success',1000,'/admin/posts',"${options.admin_pjax!'true'}");
            }else{
                jump.showMsg(data.msg,'error',2000);
            }
        },'JSON')
    ...
    function removeThumbnail(){
        $("#selectImg").attr("src","/static/jump-frontend/images/thumbnail/thumbnail.png");
    }
</script>
</@footer>
</#compress>
