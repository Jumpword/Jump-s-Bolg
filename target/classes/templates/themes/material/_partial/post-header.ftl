...
<#if (options.theme_material_scheme!'Paradox') == "Isolation">
    <div class="post-header_info without-thumbnail">
        <!-- Author Avatar & Name -->
        <img src="${user.userAvatar!'/material/source/img/avatar.png'}" class="avatar-img" width="44px" height="44px" alt="${user.userDisplayName!'jump'}'s avatar">
        <span class="name-span">${user.userDisplayName!'Jump'}</span>
    </div>
</#if>
